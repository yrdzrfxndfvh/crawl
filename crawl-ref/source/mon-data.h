...

{
    ...
    MR_NO_FLAGS,
    10, MONS_DRACONIAN, MONS_DRACONIAN, MH_NATURAL, 40,
    { {AT_HIT, AF_FLANK, 35}, {AT_KICK, AF_PLAIN, 20},
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_FAST_REGEN | M_NO_SKELETON,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_GHOST_DEMON
        | M_NO_POLY_TO | M_NO_ZOMBIE | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_HOUND, MONS_INUGAMI, MH_NATURAL, 40,
    { {AT_BITE, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 55,
    6, 13, MST_NO_SPELLS, false, S_BARK,
...
// drakes and other lesser dragons ('k')
...

{
    ...
    { {AT_BITE, AF_DRAG, 27}, {AT_TAIL_SLAP, AF_PLAIN, 14}, AT_NO_ATK,
       AT_NO_ATK },
    12, 620,
    4, 9, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 12, SWIM_ENERGY(8),
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_BITE, AF_REACH, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 600,
...

{
    ...
    { {AT_BITE, AF_CHAOTIC, 14}, {AT_CLAW, AF_CHAOTIC, 14}, AT_NO_ATK, AT_NO_ATK },
    8, 480,
...
{ // miscast only
    ...
    M_CONFUSED | M_INSUBSTANTIAL | M_BATTY | M_NO_EXP_GAIN | M_NO_POLY_TO
        | M_FLIES,
    MR_RES_FIRE | mrd(MR_RES_COLD, 3) | mrd(MR_RES_ELEC, 3),
...

{
    ...
    M_NO_SKELETON | M_FAST_REGEN,
    MR_NO_FLAGS,
    9, MONS_WORM, MONS_BRAIN_WORM, MH_NATURAL, 20,
    { {AT_BITE, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 200,
...
// small horrors and tentacled things ('x')
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_NO_POLY_TO | M_FAST_REGEN
        | M_NO_ZOMBIE | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    12, MONS_GIANT, MONS_PROTEAN_PROGENITOR, MH_NATURAL, 180,
    { {AT_RANDOM, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 820,
...

{
    ...
    { {AT_BITE, AF_BLOODZERK, 20},
      {AT_TAIL_SLAP, AF_PLAIN, 10},
      {AT_TAIL_SLAP, AF_PLAIN, 10}, AT_NO_ATK  },
    10, 750,
    6, 8, MST_NO_SPELLS, true, S_SILENT /*?*/,
    I_ANIMAL, HT_LAND, 10, MOVE_ENERGY(7),
...
// dummy for recolouring
{
    ...
    3, 180,
    0, 10, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, MOVE_ENERGY(12),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BULLFROG}, TILE_CORPSE_BULLFROG
},

// eyes ('G')
DUMMY(MONS_FLOATING_EYE, 'G', WHITE, "floating eye", TILEP_MONS_GLASS_EYE)
...

{
    ...
    M_NO_SKELETON | M_WEB_IMMUNE | M_UNBLINDABLE,
    MR_RES_POISON,
    ...
    I_BRAINLESS, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_BLOB /* close enough */,
    {TILEP_MONS_JELLYFISH}, TILE_ERROR
},
...

{
    ...
    I_HUMAN, HT_LAND, 10, SPELL_ENERGY(15),
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_FIRE, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 640,
...
// that they wield two weapons... I'm raising their xp modifier. - bwr
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK },
    10, 550,
...

{
    ...
    { {AT_TENTACLE_SLAP, AF_RIFT, 22},
      {AT_TENTACLE_SLAP, AF_REACH, 17},
      {AT_TENTACLE_SLAP, AF_DISTORT, 13},
      AT_NO_ATK },
    16, 900,
...

{
    ...
    { {AT_TENTACLE_SLAP, AF_PLAIN, 22}, {AT_TENTACLE_SLAP, AF_PLAIN, 17},
      {AT_TENTACLE_SLAP, AF_PLAIN, 13}, {AT_CONSTRICT, AF_CRUSH, 8} },
    23, 1265,
    5, 5, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...
// yaks, sheep, elephants, and other beasts ('Y')
{
    ...
    { {AT_HEADBUTT, AF_PLAIN, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 220,
...
// Semi-unique humans ('@')
{
    ...
    M_SPEAKS | M_ALWAYS_NAMED | M_WARM_BLOOD | M_SEE_INVIS,
    MR_NO_FLAGS,
...

{
    ...
    M_SPEAKS | M_ALWAYS_NAMED | M_WARM_BLOOD | M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 1500,
...

{
    ...
    M_WARM_BLOOD | M_FIGHTER | M_TWO_WEAPONS | M_SPEAKS | M_ALWAYS_NAMED | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
...

{
    ...
    MR_RES_COLD,
    24, MONS_ANCIENT_CHAMPION, MONS_ANCIENT_CHAMPION, MH_UNDEAD, 120,
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK },
    20, 980,
...
// spectral weapon, for spectral weapons.
{
    MONS_SPECTRAL_WEAPON, '(', GREEN, "spectral weapon",
    M_INSUBSTANTIAL | M_AVATAR | M_NO_EXP_GAIN | M_FLIES
        | M_GHOST_DEMON | M_UNBLINDABLE,
    MR_RES_FIRE | MR_RES_COLD |  MR_RES_ELEC,
...
// Demonic tentacle things.
{
    ...
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_RES_ACID, 3),
...
{   // evil spriggan riders
    ...
    15, 1500,
    8, 12, MST_EXECUTIONER, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(5),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_HUMANOID, // ??
...

{
    ...
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(7),
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE,
         MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    { {AT_HIT, AF_FLANK, 5}, {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK },
    1, 90,
...

{
    ...
    { {AT_HIT, AF_DRAG, 36}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 710,
    15, 10, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// statues and statue-like things ('8')
{
...

{
    ...
    M_NOT_DANGEROUS | M_STATIONARY | M_REMNANT,
    MR_NO_FLAGS,
...

{
    ...
    M_NO_POLY_TO | M_CONJURED | M_NO_EXP_GAIN,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    ...
    {TILEP_MONS_BOULDER_BEETLE_ROLLING}, TILE_ERROR
},

{
    MONS_ASPIRING_FLESH, '*', ETC_RANDOM, "aspiring flesh",
    M_NO_POLY_TO | M_NO_EXP_GAIN | M_NO_SKELETON | M_FAST_REGEN
        | M_STATIONARY | M_NO_ZOMBIE | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
...
// "D"ragons and hydras.
{
    ...
    { {AT_BITE, AF_PLAIN, 44}, {AT_CLAW, AF_PLAIN, 20},
      {AT_TRAMPLE, AF_TRAMPLE, 27}, AT_NO_ATK },
    20, 2350,
...
// Mobile plants and fungi ('f')
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE | M_FAST_REGEN
        | M_ALWAYS_WAND | M_NO_SKELETON,
    MR_NO_FLAGS,
    24, MONS_VINE_STALKER, MONS_VINE_STALKER, MH_NATURAL, 20,
    { {AT_HIT, AF_STEAL, 9}, {AT_BITE, AF_ANTIMAGIC, 9}, AT_NO_ATK,
       AT_NO_ATK },
    5, 600,
...

{
    ...
    M_UNIQUE | M_SPEAKS | M_GENDER_NEUTRAL,
    MR_NO_FLAGS,
...
// "J"ellies.
{
    ...
    M_SEE_INVIS | M_UNBLINDABLE | M_ACID_SPLASH | M_UNIQUE | M_EAT_DOORS
        | M_TALL_TILE | M_WEB_IMMUNE | M_NO_SKELETON,
    MR_RES_POISON | mrd(MR_RES_ACID, 3),
...
// Horrors and tentacled things.

{
    MONS_ERICA, 'x', LIGHTMAGENTA, "Erica",
    M_UNIQUE | M_NO_SKELETON | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
...

{
    ...
    { {AT_HIT, AF_COLD, 35}, {AT_HIT, AF_FIRE, 35}, AT_NO_ATK, AT_NO_ATK },
    23, 2700,
...

{
    ...
    { {AT_HIT, AF_CONFUSE, 36}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 2100,
...

{
    ...
    MR_NO_FLAGS,
    17, MONS_DEMIGOD, MONS_DEMIGOD, MH_NATURAL, 140,
    { {AT_HIT, AF_PLAIN, 50}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    23, 1975,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_TALL_TILE
        | M_GENDER_NEUTRAL,
    mrd(MR_RES_ELEC | MR_RES_ACID, 3) | MR_RES_POISON
        | MR_RES_DAMNATION | MR_RES_FIRE | MR_RES_COLD,
